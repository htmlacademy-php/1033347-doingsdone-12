...
INSERT INTO users (email, user_login, user_password)
VALUES ('tony@stark.org', 'tony_stark', 'morgan3000'),
       ('bruce@wayne.org', 'Im_Batman', 'selina'),
       ('fedor@dostoevsky.com', 'Dostoevsky', 'zero123');

INSERT INTO projects (project_title, user_id)
VALUES ('Mark L', 1),
       ('Спасительница', 1),
       ('Gotham', 2),
       ('Superman', 2),
...
INSERT INTO tasks (task_title, status, user_id, project_id)
VALUES ('Обновить програмное обеспечение',
        false,
        1,
        1),
